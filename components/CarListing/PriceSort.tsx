...
import { DollarSign, ArrowUp, ArrowDown } from "lucide-react"; // Correct import
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const PriceSort = ({ onValueChange }: { onValueChange: (value: string) => void }) => {
