...
import { Weight, ArrowUp, ArrowDown } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const WeightSort = ({ onValueChange }: { onValueChange: (value: string) => void }) => {
