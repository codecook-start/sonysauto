...
import { Expand, ArrowUp, ArrowDown } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export const SizeSort = ({ onValueChange }: { onValueChange: (value: string) => void }) => {
